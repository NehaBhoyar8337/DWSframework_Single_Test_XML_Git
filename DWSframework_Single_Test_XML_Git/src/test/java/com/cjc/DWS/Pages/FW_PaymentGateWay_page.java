...
public class FW_PaymentGateWay_page extends Browser_Url {
	
	static Logger log= Logger.getLogger(FW_PaymentGateWay_page.class.getName());
	...
	public FW_PaymentGateWay_page(WebDriver driver)
	{
		this.driver=driver;
